...
final class UriLinkProviderTest extends TestCase
{
    ...
    public function decode(): void
    {
        ...
        $this->assertSame(
            ...
            \array_map(static fn(UriLink $link) => $link->toString(), $links->getLinks()),
        );
    ...
    public function countable_and_iterable(): void
    {
        ...
        $this->assertSame(
            ...
            \array_map(static fn(UriLink $link) => $link->toString(), \iterator_to_array($links)),
        );
    }
    ...
    public function links_are_normalized(): void
    {
        ...
        $this->assertSame(
            ...
            \array_map(static fn(UriLink $link) => $link->toString(), $links->getLinksByRel('next')),
        );
    }
